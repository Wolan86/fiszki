...
describe("useLearningSession", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should handle custom parameters correctly", async () => {
      // Arrange
      renderHook(() => useLearningSession({ limit: 10, sourceTextId: "source-123" }));
      ...
      // Assert
      expect(mockFetch).toHaveBeenCalledWith("/api/flashcards/learning?limit=10&source_text_id=source-123");
    });
  ...
  describe("URL Construction", () => {
    ...
    it("should construct URL correctly with only limit", async () => {
      // Arrange
      renderHook(() => useLearningSession({ limit: 5 }));
    ...
    it("should construct URL correctly with only sourceTextId", async () => {
      // Arrange
      renderHook(() => useLearningSession({ sourceTextId: "abc-123" }));
    ...
    it("should construct URL correctly with all parameters", async () => {
      // Arrange
      renderHook(() => useLearningSession({ limit: 15, sourceTextId: "xyz-789" }));
  ...
  describe("Error Handling", () => {
    it("should handle errors during flashcard fetching", async () => {
      // Arrange
