...
export const generateFlashcards = async (sourceTextId: string, count?: number): Promise<GenerateFlashcardsResponse> => {
...
export const updateFlashcard = async (id: string, update: UpdateFlashcardCommand): Promise<FlashcardDto> => {
