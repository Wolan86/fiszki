...
describe('FlashcardContent', () => {
  ...
  describe('content rendering', () => {
    ...
    it('should render multiline content correctly', () => {
      ...
      expect(screen.getByTestId('flashcard-front-content').querySelector('p')).toHaveTextContent('Line 1 Line 2 Line 3');
    });
  ...
  describe('edge cases', () => {
    it('should handle undefined content gracefully', () => {
      // Arrange
      const undefinedProps = { ...defaultProps, frontContent: undefined as any, backContent: undefined as any };
    ...
    it('should handle null content gracefully', () => {
      // Arrange
      const nullProps = { ...defaultProps, frontContent: null as any, backContent: null as any };
