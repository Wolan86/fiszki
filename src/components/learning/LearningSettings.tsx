    ...
    <div style={modalStyle} onClick={onClose}>
      <div style={contentStyle} onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-foreground">Ustawienia Nauki</h2>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6">
          ...
          <div className="setting-group">
            ...
            <select
              ...
              onChange={(e) => handleSettingChange('cardOrder', e.target.value as any)}
              className="w-full p-2 border border-border rounded-md bg-background text-foreground"
            >
          ...
          <div className="setting-group">
            ...
            <select
              ...
              onChange={(e) => handleSettingChange('reviewMode', e.target.value as any)}
              className="w-full p-2 border border-border rounded-md bg-background text-foreground"
            >
            ...
            <div className="flex space-x-4">
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2"
                />
                <label htmlFor="cards" className="text-sm text-foreground">Liczba kart</label>
              </div>
              <div className="flex items-center">
                <input
                  type="radio"
                  ...
                  className="mr-2"
                />
                <label htmlFor="time" className="text-sm text-foreground">Czas</label>
              </div>
            </div>
            <div className="mt-2">
              <input
              ...
              <div className="flex justify-between text-xs text-muted-foreground mt-1">
                <span>{localSettings.sessionLength} {localSettings.sessionType === 'cards' ? 'kart' : 'min'}</span>
