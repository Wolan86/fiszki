  ...
  return (
    <div className={`${className} fade-in`} style={containerStyle}>
      <div
        ...
        role="button"
        tabIndex={0}
        aria-label={`Flashcard: ${isFlipped ? "showing back" : "showing front"}. Press Enter or Space to flip.`}
      >
        {/* Przednia strona */}
        <div style={faceStyle} data-face="front">
          <div style={contentStyle}>
            ...
            <div className="text-lg text-center leading-relaxed">{truncateText(flashcard.front_content)}</div>
          </div>
        </div>
        ...
        <div style={backStyle} data-face="back">
          <div style={contentStyle}>
            ...
            <div className="text-lg text-center leading-relaxed">{truncateText(flashcard.back_content)}</div>
          </div>
        </div>
      </div>
    </div>
