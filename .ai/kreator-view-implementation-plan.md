...
// Użycie:
const { content, setContent, wordCount, isValid, isSaving, lastSaved, errors, saveSourceText } = useSourceText({
  minWordCount: 1000,
  maxWordCount: 10000,
  autosaveDelay: 2000,
});
...
// Użycie:
const { flashcards, isGenerating, generationStats, error, generateFlashcards, updateFlashcard, regenerateFlashcard } =
  useFlashcardGeneration();
```
